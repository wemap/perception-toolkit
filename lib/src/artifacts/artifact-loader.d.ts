...
export declare class ArtifactLoader {
    ...
    fromHtmlUrl(url: URL | string): Promise<import("./schema/ar-artifact.js").ARArtifact[]>;
    fromJsonUrl(url: URL | string): Promise<import("./schema/ar-artifact.js").ARArtifact[]>;
    fromDocument(doc: Document, url: URL | string): Promise<import("./schema/ar-artifact.js").ARArtifact[]>;
